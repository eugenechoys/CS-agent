# CHOYS Employee Onboarding Guide

Welcome to CHOYS! Follow these steps to get started as an employee user.

## 1. Download the CHOYS app
- Go to the **App Store** (iOS) or **Google Play Store** (Android).
- Search for **"CHOYS"**.
- Download and install the app on your mobile device.

## 2. Sign up using your company invite code
- Open the CHOYS app.
- Tap **Sign Up / Create Account**.
- Enter the **invite code** provided by your **HR team**.
- Follow the on-screen instructions to complete registration (e.g., work email, name, password).

## 3. Complete your profile and add dependents
- After signing up, go to your **Profile** section.
- Fill in your personal details as requested (e.g., contact info, demographics, preferences where applicable).
- If your company plan supports dependents:
...
If you face any issues during onboarding, contact your HR team or reach out to CHOYS support through the in-app help / support section.